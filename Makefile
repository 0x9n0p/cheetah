...
kernel:
	...
	x86_64-elf-gcc $(CFLAGS) $(CFLAGS_PROGRAM) -mno-red-zone -c src/kernel.c -o build/kernel.c.o
...
image: bootloader kernel
	...
	dd if=/dev/zero of=build/cheetah.img bs=512 count=8 seek=17 conv=notrunc
